...
fon = transform.scale(image.load("fon2(звездные войны).jpg"),(500,500))
plat = Player('player(Звезднй корабль1).jpg', 5, win_width - 80,4)
plat2 = Player('player(Звезднй корабль2).jpg', 435, win_width - 80,4)
